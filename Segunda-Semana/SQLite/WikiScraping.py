...
def coso ():
#creamos un set con nuestras variables y sus valores
    countries = {
...
#        print (s)
    ...
    info_countries = {
        "Grecia":{
            "history": all_history_Greece,
            "surface": all_surface_Greece,
            "population": all_population_Greece,
            "pib": all_pib_Greece
        },        
        "Italia":{
            "history": all_history_Italy,
            "surface": all_surface_Italy,
            "population": all_population_Italy,
            "pib": all_pib_Italy
        }
    }
